...
class TestSpaces(unittest.TestCase):
    ...
    def test_to_space(self):
        ...
        self.assertIsInstance(space[0], np.ndarray)
        self.assertIsInstance(space[1], np.ndarray)
        ...
        self.assertEqual(len(space), 3)
        self.assertIsInstance(space['b'], np.ndarray)
        self.assertIsInstance(space['m'], np.ndarray)
